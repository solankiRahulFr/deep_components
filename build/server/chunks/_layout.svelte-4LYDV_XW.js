import { c as create_ssr_component, a as subscribe, b as add_attribute, v as validate_component, s as setContext, d as compute_rest_props, g as getContext, e as spread, f as escape, h as escape_attribute_value, i as escape_object, j as createEventDispatcher, m as missing_component, k as compute_slots } from './ssr-QcpZni2m.js';
import { p as page } from './stores-ICJBnHX0.js';
import { i as initializeModalStore, T as TabGroup, p as prefersReducedMotionStore, g as getModalStore, m as modeCurrent, s as setInitialClassState, f as fly } from './TabGroup-jS5De9vw.js';
import { w as writable } from './index-ogegri_B.js';
...
const Logo = "/_app/immutable/assets/logo512.5kEHEa3C.png";
const css = {
  code: ".custom-modal article{overflow-y:scroll;height:100%;max-height:80%;padding-left:0.3rem;padding-right:0.3rem}.custom-modal article pre{white-space:pre-wrap}.custom-modal article{white-space:pre-wrap}",
  map: null
};
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `<nav class="fixed w-full z-10 bg-[#dfe0e2] dark:bg-[#15171f] m-0 p-0 top-0"><div class="flex justify-between items-center pt-2 pb-2 pr-4 pl-4"><a href="/" data-svelte-h="svelte-bfxs54"><img${add_attribute("src", Logo, 0)} alt="logo" class="w-12"></a> <div class="flex justify-between items-center gap-5">${$page.url.pathname !== "/" ? `<a${add_attribute("href", installationRef, 0)} target="_blank" type="button" class="btn btn-sm variant-ghost-secondary text-xs">Installation/ Docs</a>` : ``} ${validate_component(TabGroup, "TabGroup").$$render(
    $$result,
    {
    ...
    {},
    {
      default: () => {
        return `${validate_component(TabAnchor, "TabAnchor").$$render(
          ...
          {
            href: "/pytorch",
            selected: $page.url.pathname === "/pytorch",
            class: "text-base text-center cursor-pointer px-4 py-1 rounded-token hover:variant-soft-primary text-xs"
          },
          {},
          {
            default: () => {
              return `<span class="text-xs" data-svelte-h="svelte-1izh5lr">Pytorch</span>`;
            }
          }
          ...
          {
            href: "/flax",
            selected: $page.url.pathname === "/flax",
            class: "text-base text-center cursor-pointer px-4 py-1 rounded-token hover:variant-soft-primary text-xs"
          },
          {},
          {
            default: () => {
              return `<span class="text-xs" data-svelte-h="svelte-144pq3t">Flax</span>`;
            }
          }
        )} ${validate_component(TabAnchor, "TabAnchor").$$render(
          $$result,
          {
            href: "/libtorch",
            selected: $page.url.pathname === "/libtorch",
            class: "text-base text-center cursor-pointer px-4 py-1 rounded-token hover:variant-soft-primary text-xs"
          },
          {},
          {
            default: () => {
              return `<span class="text-xs" data-svelte-h="svelte-pfdjt">Libtorch</span>`;
            }
          }
        )}`;
      }
    }
  )} ${validate_component(LightSwitch, "LightSwitch").$$render($$result, {}, {}, {})}</div></div></nav> ${validate_component(Modal, "Modal").$$render(
    $$result,
    {
      rounded: "rounded-md",
      width: "w-9/12",
...
//# sourceMappingURL=_layout.svelte-4LYDV_XW.js.map
